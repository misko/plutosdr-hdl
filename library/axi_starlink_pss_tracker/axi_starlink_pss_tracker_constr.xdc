...
# The 64-bit injection start mailbox is immutable from the AXI arm
...
set pss_tracker_injection_payload_source [get_cells -quiet -hier -regexp \
  {.*i_injection_mux/arm_start_mailbox_reg\[[0-9]+\].*}]
set pss_tracker_injection_payload_sync_1 [get_cells -quiet -hier -regexp \
  {.*i_injection_mux/arm_start_sync_1_reg\[[0-9]+\].*}]
set_bus_skew 10.000 \

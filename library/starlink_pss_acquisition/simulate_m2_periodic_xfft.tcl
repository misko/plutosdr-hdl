# Vivado 2022.2 bit-exact M2 periodic-fixture XFFT simulation.
# Usage: vivado -mode batch -source simulate_m2_periodic_xfft.tcl \
...
set project_name starlink_pss_m2_periodic_xfft_sim
file mkdir $output_dir

foreach required_file {m2_period_samples_ci16.mem m2_period_scores_u8.mem} {
  if {![file isfile [file join $vector_dir $required_file]]} {
    error "missing M2 replay vector $required_file"
  }
}
...
add_files -fileset sim_1 -norecurse \
  [file join $script_dir tb tb_starlink_pss_m2_periodic_xfft.sv]
add_files -fileset sim_1 -norecurse \
  [file join $script_dir tb upper_edge_pss_kernel_q17.mem]
foreach vector_file [glob [file join $vector_dir m2_period_*.mem]] {
...
set_property top tb_starlink_pss_m2_periodic_xfft [get_filesets sim_1]
...
puts "STARLINK_M2_PERIODIC_XFFT_SIMULATION_COMPLETE"

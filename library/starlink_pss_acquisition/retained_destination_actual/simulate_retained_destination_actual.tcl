...
set runner [file join $source_dir hdl library starlink_pss_acquisition retained_destination_actual simulate_retained_destination_actual.tcl]
...
set py [list env -u PYTHONHOME -u PYTHONPATH -u PYTHONOPTIMIZE -u LD_LIBRARY_PATH $python -B \
  [file join $source_dir tools prepare_starlink_retained_destination_actual.py]]
...
puts "RETAINED_DESTINATION_ACTUAL_VERIFIED_SEVEN_CONTEXTS_NO_CONTINUOUS_OR_PHYSICAL_CLAIM"

...
`timescale 1ns/1ps
module starlink_pss_realtime_input_guard_staged_identity #(
  ...
  // Must accompany the exact buffered beat, checked against this job at capture.
  ...
  // Wide comparison was performed before the PRIVATE beat register. Keep
  // ordinal/TLAST, demand, duplicate-start and sticky fault checks below live.
  // The caller must never use this checker without the identity/data stage.
  assign identity_matches = input_identity_good === 1'b1;

    ...
    begin
      ...
      fork
        ...
        begin
          ...
          else force dut.inverse_guard_ready=1'b0;
          repeat(10)begin
            @(negedge fft_clk);
          ...
          if(which<4)begin
            release dut.result_destination_ready;release dut.inverse_guard_ready;release dut.cutover_admission_capacity;
            n=0;
            ...
            release dut.engine_metadata;release dut.result_destination_ready;release dut.inverse_guard_ready;release dut.cutover_admission_capacity;
          end
        end
      join

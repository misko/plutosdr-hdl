...
module starlink_pss_spectrum_product_bank_arithmetic #(
  ...
  output wire                 pipeline_full, // PARALLEL READY OCCUPANCY
  ...
  // BEGIN PARALLEL READY ARITHMETIC OBSERVATION
  // Current owning registers, never the externally overridable valid wire.
  assign pipeline_full = product_valid && sum_valid && output_valid;
  // END PARALLEL READY ARITHMETIC OBSERVATION

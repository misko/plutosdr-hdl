...
set runner [file join $source_dir hdl library starlink_pss_acquisition retained_output_actual simulate_retained_output_actual.tcl]
...
set py [list env -u PYTHONHOME -u PYTHONPATH -u PYTHONOPTIMIZE -u LD_LIBRARY_PATH $python -B \
  [file join $source_dir tools prepare_starlink_retained_output_actual.py]]
...
puts "RETAINED_OUTPUT_ACTUAL_VERIFIED_SEVEN_CONTEXTS_NO_CONTINUOUS_OR_PHYSICAL_CLAIM"

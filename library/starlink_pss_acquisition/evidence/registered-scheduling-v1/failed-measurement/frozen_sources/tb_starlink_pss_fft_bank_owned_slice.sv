...
module tb_starlink_pss_fft_bank_owned_slice;
  ...
  always @(posedge fft_clk) begin
    if (!dut.fast_running) begin
      ...
      if (dut.completion_accept) completion_capture_cycle = fast_cycle;
    ...
    if (REGISTERED_SCHEDULING) begin
      ...
      for (test_kind = 0; test_kind < 8; test_kind = test_kind + 1) begin
        ...
        case (test_kind)
          ...
          4: begin wait(dut.admission_receipt); force dut.core_status_valid = 1; end
        ...
        release dut.core_status_valid; release dut.event_last_missing; release dut.event_frame;

...
set log {EXACT_CONTROL_EXTRA_EPOCHS_PASS final_faults=2 held_final_stalls=3 one_sided_resets=2 healthy_recoveries=4
EXACT_CONTROL_EXTRA_EPOCHS_PASS final_faults=2 held_final_stalls=3 one_sided_resets=2 healthy_recoveries=4
EXACT_CONTROL_ACTUAL_PASS registered=1 distributed=1 scratch=x extra=1 checks=500 active=300 consumed=2 private_differences=19 final_fault_edges=2 owned_stalls=9 reset_owned_edges=0 independent_actual_core=1
}

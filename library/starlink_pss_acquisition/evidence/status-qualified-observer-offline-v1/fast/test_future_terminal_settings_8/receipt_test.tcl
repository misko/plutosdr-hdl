...
EXACT_CONTROL_ACTUAL_PASS registered=1 distributed=1 scratch=1 extra=1 checks=500 active=0 consumed=2 private_differences=19 final_fault_edges=2 owned_stalls=9 reset_owned_edges=0 independent_actual_core=1
}

`timescale 1ns/1fs
module tb_starlink_pss_exact_control_reference;
  ...
  starlink_pss_fft_bank_owned_slice_dec20d63_golden #(.REGISTERED_SCHEDULING(REGISTERED_SCHEDULING)) dut (.*);
  ...
  starlink_pss_realtime_input_guard_dec20d63_golden #(.CHECK_INPUT_BLOCK_IDENTITY(1)) old_input_guard (
  ...
  starlink_pss_realtime_result_guard_dec20d63_golden shadow (
  ...
  endtask
  initial begin
    trace = $fopen("exact_control_reference_trace.csv", "w");

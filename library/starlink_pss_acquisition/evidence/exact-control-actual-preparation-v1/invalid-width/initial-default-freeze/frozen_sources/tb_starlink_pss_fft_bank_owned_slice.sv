...
module tb_starlink_pss_fft_bank_owned_slice;
  ...
  localparam integer EXACT_WIDTH = $bits({resetn,
    fft_resetn,
    input_valid,
    input_last,
    input_data,
    ...
    dut.output_bank.output_ready});
  wire [EXACT_WIDTH-1:0] exact_actual_public = {resetn,
    fft_resetn,
    input_valid,
    input_last,
    input_data,
    ...
    dut.output_bank.output_valid,
    dut.output_bank.output_ready};
  wire [EXACT_WIDTH-1:0] exact_reference_public = {exact_reference.resetn,

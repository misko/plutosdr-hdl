...
cd $old_directory
puts [exec {PYTHON} $audit_helper --verify $evidence_dir --expected $expected_prepared]
...
set prior_sources [file join $evidence_dir frozen_sources]
"""
COPY_VERIFY = f"puts [exec {PYTHON} $audit_helper --verify $evidence_dir --expected $expected_prepared --copied $source_dir]\n"

...
set -u -o pipefail
set -C
rom_prepared=/tmp/starlink-rom-prefetch.j829ht/rom-actual-prepared-v1
rom_owner=/tmp/starlink-rom-prefetch.j829ht/rom-actual-owner-v1
...
project = Path('/tmp/starlink-rom-prefetch.j829ht/rom-actual-prepared-v1/project')
...
owner = Path('/tmp/starlink-rom-prefetch.j829ht/rom-actual-owner-v1')

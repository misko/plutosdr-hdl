  ...
  always @(posedge fft_clk) begin
    ...
    always @(posedge fft_clk) begin
      if (!fast_running) begin
        ...
        if (certified_input_complete) engine_input_reserved <= 0;
        if (guard_commit[0] && !next_inverse)
          forward_committed <= 1;

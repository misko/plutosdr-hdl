...
set rtl_names {starlink_pss_fft_bank_owned_product_fence starlink_pss_realtime_input_guard
...
set_property top starlink_pss_fft_bank_owned_product_fence [get_filesets sources_1]

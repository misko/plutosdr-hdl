...
PREP = ROOT / 'product-final-physical-prepared-v1'
EXPECTED = 'b3c446578c0c35f8e0f199aa12f66d8635b6f7d21c9b97713a5ffed2ac2b0f06'
...
assert len(source_rows) == 15  # 14 inputs plus the separately identified simulation log.
...
for name in ('REGISTERED_SCHEDULING', 'DISTRIBUTED_FAST_FAULT', 'PRIVATE_NEXT_START_SCRATCH', 'PER_CAUSE_FAULT_CDC', 'PRIVATE_ROM_READ_AHEAD', 'PRIVATE_BLOCK_METADATA_READ_AHEAD', 'PRODUCER_LOCAL_FINAL_FENCE'):
...
owner = ROOT / 'product-final-route-v1/own_route.py'
old_owner = ROOT / 'rom-k1m1-route-v1/own_route.py'
restored = owner.read_text()
for new, old in (
    ('product-final-synthesis-v1/synthesis/fft_bank_owned_synth.dcp', 'rom-k1m1-synth-v1/synthesis/fft_bank_owned_synth.dcp'),
    ('product-final-physical-prepared-v1/route_completed_input_fence.tcl', 'rom-k1m1-physical-prepared-v1/route_completed_input_fence.tcl'),
    ('41c756bdc45635b1107d73ad741826e5a8f8fa276dc159468ec2355c16203aa6', '264b7dbb89ccef59b1b41dbaee2e01d4138b8d9a368f64ebc6532efd04f5405e'),
):
...
emit('independent-post-audit.json', {
    'original_handle': 75133, 'original_terminal': terminal,
    ...
    'route_proposal_whole_source_three_replacement_inverse': True,
    'route_launched': False, 'independent_audit_pass': True,
})
print('INDEPENDENT_PRODUCT_FINAL_SYNTHESIS_AUDIT_PASS; route owner three-change inverse PASS; route NOT launched')

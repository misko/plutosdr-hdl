...
`timescale 1ns/1ps
module starlink_pss_fft_bank_owned_slice_cdc_golden #(
  ...
  starlink_pss_block_mailbox_cdc_golden #(.RESET_RELEASE_EXTERNAL(1)) source_bank (
  ...
  starlink_pss_realtime_input_guard_cdc_golden #(.CHECK_INPUT_BLOCK_IDENTITY(1),
  ...
  starlink_pss_realtime_result_guard_cdc_golden #(.USE_COMPLETED_INPUT_FAULT(1),
  ...
  starlink_pss_forward_kernel_join_cdc_golden #(.KERNEL_ROM_FILE(KERNEL_ROM_FILE), .DATA_WIDTH(18),
  ...
  starlink_pss_spectrum_product_cdc_golden #(.DATA_WIDTH(18),
  ...
  starlink_pss_block_mailbox_cdc_golden #(.RESET_RELEASE_EXTERNAL(1), .EXPLICIT_COMMIT(1)) product_bank (
  ...
  starlink_pss_block_mailbox_cdc_golden #(.METADATA_WIDTH(75), .RESET_RELEASE_EXTERNAL(1),

...
wire completed_input_fault_now = external_fault_now || certified_input_beat || certified_input_complete;
  wire preflight_fault_evidence_now = 1'bz;
  starlink_pss_realtime_result_guard #(.WATCHDOG_CYCLES(WATCHDOG_CYCLES), .USE_COMPLETED_INPUT_FAULT(1)) dut (

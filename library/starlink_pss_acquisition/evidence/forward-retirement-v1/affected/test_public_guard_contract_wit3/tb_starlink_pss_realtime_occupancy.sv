...
module tb_starlink_pss_realtime_occupancy;
  ...
  wire phase_input_fault_now = external_fault_now || certified_input_beat || certified_input_complete; // Default mode must ignore this input.
  ...
  starlink_pss_realtime_result_guard #(.USE_PHASE_INPUT_FAULT(2)) dut (

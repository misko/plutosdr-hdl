...
prepared=out.parent/'checked-product-actual-prepared-v1'
gate=out.parent/'checked-run-parent.pA6npmAc'
...
cli=prepared/'prepare_checked_product_actual_run.py'
project=prepared/'project'
expected='9b21ff51490f0deb87ae0b69a78e65e37895bb8006f67b2615a567e70e8e63c7'
...
assert len(pins)==84 and all(sha(prepared/n)==v for n,v in pins.items())

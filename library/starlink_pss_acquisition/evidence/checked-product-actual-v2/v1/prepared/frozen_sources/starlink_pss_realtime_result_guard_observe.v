...
module starlink_pss_realtime_result_guard_observe #(
  ...
  // Observation of the exact old ACK-clear event; no internal state/control
  // expression changes. A bank transport ACK remains a separate transaction.
  assign validated_ack = resetn && awaiting_ack && mailbox_input_ready &&
    !protocol_fault && !idle_fault_now;

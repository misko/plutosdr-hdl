...
puts [exec env -u PYTHONHOME -u PYTHONPATH -u LD_LIBRARY_PATH /home/mouse9911/gits/pluto-plus-utils/.venv/bin/python -B [file join $output_dir prepare_checked_product_drain_actual.py] --verify-prepared $output_dir]
...
puts [exec env -u PYTHONHOME -u PYTHONPATH -u LD_LIBRARY_PATH /home/mouse9911/gits/pluto-plus-utils/.venv/bin/python -B [file join $output_dir prepare_checked_product_drain_actual.py] --verify-result $output_dir]
cd $output_dir
exec sha256sum -c SHA256SUMS --quiet
cd $old_directory
close_project

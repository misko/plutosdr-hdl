`timescale 1ns/1fs
module tb_starlink_pss_bank_arithmetic_actual;
  ...
  starlink_pss_bank_arithmetic_shadow #(.O(O)) payload_shadow (
    ...
    .product_outputs({dut.product.input_ready, dut.product.output_valid, dut.product.output_i,
      dut.product.output_q, dut.product.arithmetic.output_bin_index, dut.product.output_block_exponent,
      dut.product.output_last, dut.product.arithmetic.output_block_start_index, dut.product.arithmetic.output_overflow,
      dut.product.overflow_pulse}),
    .product_private({dut.product.arithmetic.product_valid, dut.product.arithmetic.product_ii, dut.product.arithmetic.product_qq,
      dut.product.arithmetic.product_iq, dut.product.arithmetic.product_qi}),

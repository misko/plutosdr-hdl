# Vivado 2022.2 long-horizon gate for the 30 -> 15 MS/s DDC and real XFFTs.
# Usage: vivado -mode batch -source simulate_pss30_ddc_to_score_xfft_longrun.tcl \
#        -tclargs OUTPUT
...
set project_name starlink_pss30_ddc_to_score_xfft_longrun_sim
...
add_files -fileset sim_1 -norecurse \
  [file join $script_dir tb tb_starlink_pss30_ddc_to_score_xfft_longrun.sv]
add_files -fileset sim_1 -norecurse \
  [file join $script_dir tb upper_edge_pss30_x2_ddc_kernel_q17.mem]
set_property file_type {Memory Initialization Files} \
  [get_files -of_objects [get_filesets sim_1] *.mem]
set_property top tb_starlink_pss30_ddc_to_score_xfft_longrun [get_filesets sim_1]
...
puts "STARLINK_PSS30_DDC_TO_SCORE_XFFT_LONGRUN_SIMULATION_COMPLETE"

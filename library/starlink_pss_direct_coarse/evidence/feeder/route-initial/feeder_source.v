...
module starlink_pss_direct_feeder #(
  ...
  assign config_rejected = resetn && config_valid && config_bank >= 6;
  assign gap_now = resetn && !intentional_fence &&
                   (sample_gap || (sample_valid && have_timestamp &&
  ...
  assign expiry_now = resetn && !intentional_fence && !gap_now &&
                      sample_valid && pending_span >= 16'd128;
  assign segment_fence = resetn && (intentional_fence || gap_now || expiry_now);

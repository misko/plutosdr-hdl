...
// engine only after all 130 tagged samples have been written and capture_done
...
module starlink_pss_capture_bridge (
  ...
  output wire          [7:0] o_engine_sample_slot,
  ...
  wire [8:0] capture_memory_address = {
    capture_memory_bank,
    i_capture_slot
  };
  ...
  reg engine_bank;
  reg [7:0] engine_slot;
  wire [8:0] engine_memory_address = {engine_bank, engine_slot};
